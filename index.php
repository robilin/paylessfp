...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="description" content="metring redifined" />
	<meta name="keywords" content="payless, Bill payment automation" />
	<meta name="author" content="payless.co.tz" />
			...
			<div class="container">
				<div class="row text-center row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2">
						<figure class="fh5co-devices animate-box"><img src="images/img_devices.png" alt="" class="img-responsive"></figure>
		...
		<footer id="fh5co-footer">
			...
			<div class="fh5co-copyright animate-box">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="fh5co-left"><small>&copy; 2017 <a href="index.php"></a>Payless&trade; . All Rights Reserved.</small></p>
